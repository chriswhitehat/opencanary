...
class LoggerBase(object):
    LOG_BASE_BOOT                               = 'LOG_BASE_BOOT'
    LOG_BASE_MSG                                = 'LOG_BASE_MSG'
    LOG_BASE_DEBUG                              = 'LOG_BASE_DEBUG'
    LOG_BASE_ERROR                              = 'LOG_BASE_ERROR'
    LOG_BASE_PING                               = 'LOG_BASE_PING'
    LOG_BASE_CONFIG_SAVE                        = 'LOG_BASE_CONFIG_SAVE'
    LOG_BASE_EXAMPLE                            = 'LOG_BASE_EXAMPLE'
    LOG_FTP_LOGIN_ATTEMPT                       = 'LOG_FTP_LOGIN_ATTEMPT'
    LOG_HTTP_GET                                = 'LOG_HTTP_GET'
    LOG_HTTP_POST_LOGIN_ATTEMPT                 = 'LOG_HTTP_POST_LOGIN_ATTEMPT'
    LOG_SSH_NEW_CONNECTION                      = 'LOG_SSH_NEW_CONNECTION'
    LOG_SSH_REMOTE_VERSION_SENT                 = 'LOG_SSH_REMOTE_VERSION_SENT'
    LOG_SSH_LOGIN_ATTEMPT                       = 'LOG_SSH_LOGIN_ATTEMPT'
    LOG_SMB_FILE_OPEN                           = 'LOG_SMB_FILE_OPEN'
    LOG_PORT_SYN                                = 'LOG_PORT_SYN'
    LOG_TELNET_LOGIN_ATTEMPT                    = 'LOG_TELNET_LOGIN_ATTEMPT'
    LOG_HTTPPROXY_LOGIN_ATTEMPT                 = 'LOG_HTTPPROXY_LOGIN_ATTEMPT'
    LOG_MYSQL_LOGIN_ATTEMPT                     = 'LOG_MYSQL_LOGIN_ATTEMPT'
    LOG_MSSQL_LOGIN_SQLAUTH                     = 'LOG_MSSQL_LOGIN_SQLAUTH'
    LOG_MSSQL_LOGIN_WINAUTH                     = 'LOG_MSSQL_LOGIN_WINAUTH'
    LOG_TFTP                                    = 'LOG_TFTP'
    LOG_NTP_MONLIST                             = 'LOG_NTP_MONLIST'
    LOG_VNC                                     = 'LOG_VNC'
    LOG_SNMP_CMD                                = 'LOG_SNMP_CMD'
    LOG_RDP                                     = 'LOG_RDP'
    LOG_SIP_REQUEST                             = 'LOG_SIP_REQUEST'
    LOG_GENERIC_TCP                             = 'LOG_GENERIC_TCP'
    LOG_GENERIC_UDP                             = 'LOG_GENERIC_UDP'
    LOG_USER_0                                  = 'LOG_USER_0'
    LOG_USER_1                                  = 'LOG_USER_1'
    LOG_USER_2                                  = 'LOG_USER_2'
    LOG_USER_3                                  = 'LOG_USER_3'
    LOG_USER_4                                  = 'LOG_USER_4'
    LOG_USER_5                                  = 'LOG_USER_5'
    LOG_USER_6                                  = 'LOG_USER_6'
    LOG_USER_7                                  = 'LOG_USER_7'
    LOG_USER_8                                  = 'LOG_USER_8'
